...
```
*This creates the `.certs/` directory and `corporate_bundle.pem`.*
...
```
*This downloads the ~100MB PowerShell Core zip (if missing), extracts it to `.tools/pwsh/`, and creates a custom profile.*
