...
**Goal**: The router understands the _codebase_, not just the _file_.
...
- [ ] **Slice 2.2: Refactor Planner (The Brain)**
  - Send _Index_ to DeepSeek R1.
  - Receive _Plan_ (JSON list of steps).
- [ ] **Slice 2.3: Slice Execution**
  - Execute _Plan_ steps sequentially using DeepSeek V3.
