---
name: sluagh-swarm
description: Protocol for seeding a Linear backlog with optimized issues for autonomous Sluagh Swarm testing.
---

# Sluagh Swarm Seeding Protocol

This skill provides the necessary instructions and tools to seed a Linear project with 5 strategic test issues designed to verify the Sluagh autonomous swarm.
...
3.  **Swarm Resilience Simulation** (Priority: 50) - Designed to fail to test `sluagh:blocked` state.
