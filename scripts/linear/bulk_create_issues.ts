...
const issues: Issue[] = [
  ...
  {
    id: 'FLY-002',
    title: 'Create bifrost-runner App',
    desc: '**P1 | 10min**\n\nRun: flyctl apps create bifrost-runner\nDeps: FLY-001',
  },
  {
    id: 'FLY-003',
    title: 'Create bifrost-events App',
    desc: '**P1 | 10min**\n\nRun: flyctl apps create bifrost-events\nDeps: FLY-001',
  },
  {
    id: 'FLY-004',
    title: 'Configure WireGuard 6PN',
  ...
  {
    id: 'FLY-010',
    title: 'Create Volume for Events',
    desc: '**P1 | 10min**\n\nflyctl volumes create events_data --size 10 --region sea\nDeps: FLY-003',
  },
  {
    id: 'FLY-011',
    title: 'SQLite Event Schema',
  ...
  {
    id: 'FLY-013-E',
    title: 'Private-Only Event Access',
  ...
  {
    id: 'FLY-025',
    title: 'E2E Runner Lifecycle Test',
