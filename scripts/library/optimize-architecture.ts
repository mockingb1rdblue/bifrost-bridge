...
async function optimizeArchitecture() {
    ...
    const strategyPath = path.resolve(__dirname, '../../docs/temp-library/local-documentation-strategy.md');
    const architecturePath = path.resolve(__dirname, '../../docs/temp-library/local-knowledge-architecture.md');
...
`;
    ...
    try {
        ...
        fs.writeFileSync(path.resolve(__dirname, '../../docs/temp-library/perplexity-optimization.md'), response.content);
